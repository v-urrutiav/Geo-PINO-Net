...
CASE_DIR = ROOT / "examples" / "Lug_3D" / "case_001"
MODEL_PATH = ROOT / "trained_models" / "Lug_3D" / "64_lug_final.pth"
OUT_DIR = ROOT / "results" / "example_runs" / "Lug_3D"
...
def main() -> None:
    print("[INFO] Running Lug_3D example")
    ...
    print("[DONE] Lug_3D example check completed.")
